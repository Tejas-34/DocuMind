      ...
      <div class="space-y-8">
        ...
        <div class="space-y-6 pt-2">
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Upload & Manage</h3>
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Store and manage your documents.</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Ask with Confidence</h3>
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Answers based only on your documents.</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Always Private</h3>
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Strict tenant isolation for your data.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full max-w-md mx-auto bg-white dark:bg-[#121915] rounded-3xl border border-gray-100 dark:border-gray-800/90 shadow-xl shadow-black/5 dark:shadow-black/20 p-8 sm:p-10 space-y-6">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <button
            ...
            class="w-full py-3 bg-[#153826] hover:bg-[#1b4932] text-white font-medium rounded-xl text-sm shadow-xs transition-all flex items-center justify-center gap-2 disabled:opacity-60 cursor-pointer active:scale-[0.99] mt-2"
          >
        ...
        <div class="text-center pt-2 text-xs text-gray-500 dark:text-gray-400">
          ...
          <RouterLink to="/login" class="text-[#153826] dark:text-emerald-400 font-bold hover:underline ml-1">
            Sign in
          </RouterLink>
        </div>
      </div>
...
import { UploadCloud, MessageSquare, ShieldCheck, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Loader2 } from 'lucide-vue-next'
